...
import com.sandbox.main.core.maps.MapsPresenter;
import com.sandbox.main.core.settings.SettingsInteractor;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, LogoutContract.View, View.OnClickListener {
     ...
     * Pop-up interface is available at https://www.youtube.com/watch?v=0DH2tZjJtm0
